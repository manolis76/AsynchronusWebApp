<?php
    ...
    class Text {
        ...
        public function Text() {
            $baseDir = dirname(__FILE__) . "../Utilitarios/Graficos/";
        
            // Free low-res fonts based on Bitstream Vera <http://dejavu.sourceforge.net/wiki/>
            $this->fontCondensed = "../Utilitarios/Graficos/fonts/DejaVuSansCondensed.ttf";
            $this->fontCondensedBold = "../Utilitarios/Graficos/fonts/DejaVuSansCondensed-Bold.ttf";
        }
